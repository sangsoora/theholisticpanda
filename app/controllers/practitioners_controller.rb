class PractitionersController < ApplicationController
  ...
  def booking
    ...
    @pending_sessions = @practitioner.sessions.includes(:review, service: [practitioner: [{ user: :photo_attachment }]]).where(status: 'pending', free_practitioner_id: nil).order('created_at DESC')
