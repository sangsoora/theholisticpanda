class User < ApplicationRecord
  ...
  def after_confirmation
    ...
    UserPromo.create(name: 'WELCOMETOPANDA', detail: '10% off', user: self, promo_id: welcome_code.id, active: true, expires_at: Time.now + 3.months, coupon_id: 'first_booking_discount')
    ...
    if @referred_user
      ...
      UserPromo.create(name: 'REFERRAL10', detail: '10% off', user: self, promo_id: new_user_code.id, active: true, expires_at: Time.now + 3.months, coupon_id: 'referral_discount')
      ...
      UserPromo.create(name: 'REFERRAL10', detail: '10% off', user: @referred_user.user, promo_id: existing_user_code.id, active: true, expires_at: Time.now + 3.months, coupon_id: 'referral_discount')
